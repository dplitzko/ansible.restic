...
| `files_from`              |              no              | If `true`, the backup command in the script has the [`--files-from` option](https://restic.readthedocs.io/en/stable/040_backup.html#including-files) appended. So `src` can be the path (absolute) to a file which contais a lists of file patterns or paths to be backed up.                                                                                                                                                 |
